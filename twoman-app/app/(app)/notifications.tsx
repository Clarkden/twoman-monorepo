...
import {mainBackgroundColor, mainPurple, secondaryBackgroundColor} from "@/constants/globalStyles";
...
export default function NotificationsScreen() {
    ...
    const [notificationPreferences, setNotificationPreferences] = useState<NotificationType | null>(null)
    const [token, setToken] = useState<string | null>(null)

    const fetchNotificationPreferences = useCallback(async () => {
        try {
            const response = await apiFetch<NotificationType>("/user/notification/preferences")
            if (response.success) {
    ...
    const toggleNotifications = async () => {
        ...
        if (!token && newValue) {
            Alert.alert("Please enable notifications in your device settings to receive notifications.")
            return
        }
    ...
    const toggleNewMatchesNotifications = async () => {
        ...
        setNotificationPreferences(prev => prev ? {
            ...prev,
            NewMatchesNotificationsEnabled: !prev.NewMatchesNotificationsEnabled
        } : null)
    }
    ...
    const toggleNewMessagesNotifications = async () => {
        ...
        setNotificationPreferences(prev => prev ? {
            ...prev,
            NewMessagesNotificationsEnabled: !prev.NewMessagesNotificationsEnabled
        } : null)
    }
    ...
    const toggleNewFriendRequestNotifications = async () => {
        ...
        setNotificationPreferences(prev => prev ? {
            ...prev,
            NewFriendRequestNotificationsEnabled: !prev.NewFriendRequestNotificationsEnabled
        } : null)
    }
        ...
        try {
            const response = await apiFetch("/user/notification/preferences", {
                ...
                body: {
                    ...
                    new_matches_notifications_enabled: notificationPreferences.NewMatchesNotificationsEnabled,
                    new_messages_notifications_enabled: notificationPreferences.NewMessagesNotificationsEnabled,
                    new_friend_request_notifications_enabled: notificationPreferences.NewFriendRequestNotificationsEnabled
                }
            })
                    ...
                    <View style={styles.contentContainer}>
                        ...
                        <View style={styles.notificationPreferenceItem}>
                            ...
                            <Switch
                                ...
                                value={notificationPreferences.NewFriendRequestNotificationsEnabled}
                            />
                        </View>
                    </View>
                </View>
