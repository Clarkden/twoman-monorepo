...
export const createAuthMessage = (
  ...
  correlationId?: string,
): ValidatedMessage<AuthorizationMessage> => {
  return wsValidator.createValidatedMessage(
    "authorization",
    payload,
    correlationId,
  );
...
export const isConnectionSuccess = (
  data: unknown,
): data is ConnectionSuccessMessage => {
  return wsValidator.validatePayload<ConnectionSuccessMessage>(
    "connection_success",
    data,
  );
};
...
export const isConnectionFailed = (
  data: unknown,
): data is ConnectionFailedMessage => {
  return wsValidator.validatePayload<ConnectionFailedMessage>(
    "connection_failed",
    data,
  );
};
